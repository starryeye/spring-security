...
public class OAuth2NaverProviderUserConverter implements ProviderUserConverter<CreateProviderUserRequest, ProviderUser> {
    ...
    public ProviderUser convert(CreateProviderUserRequest createProviderUserRequest) {
        ...
        return new NaverUser(
                oAuth2User,
                clientRegistration,
                OAuth2UserAttributes.ofSub(oAuth2User, NAVER_SUB_ATTRIBUTES_KEY).getMainAttributes()
        );
    }
}
