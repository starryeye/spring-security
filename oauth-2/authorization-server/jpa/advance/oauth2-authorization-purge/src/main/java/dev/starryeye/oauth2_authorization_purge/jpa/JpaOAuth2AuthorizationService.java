...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    /**
     * custom-oauth2-authorization-service 프로젝트의 JPA 구현을 그대로 가져왔다. (구현 설명은 해당 프로젝트 주석 참고)
     * 이 프로젝트의 주제는 이 저장소에 쌓이는 만료 row 의 정리이다. (OAuth2AuthorizationPurgeScheduler 참고)
     */
